...
export const ORDER_STATUSES: Array<{ value: OrderStatus; label: string; badge: string }> = [
  { value: 'registrada', label: 'Registrada', badge: 'bg-sky-100 text-sky-700' },
  { value: 'en proceso', label: 'En proceso', badge: 'bg-amber-100 text-amber-700' },
  { value: 'pagado', label: 'Pagado', badge: 'bg-emerald-100 text-emerald-700' },
]
