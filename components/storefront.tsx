    ...
    <header className="sticky top-0 z-30 border-b border-border bg-background/95 px-5 py-4 backdrop-blur md:px-10"><div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-4">
        {isAuthenticated && user ? (
          ...
          <>
            <motion.button onClick={handleAuthLogin} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.92 }} transition={spring} aria-label="Registrarse o iniciar sesión con Google" className="flex items-center gap-1.5 rounded-full border border-[#1197c5]/30 bg-white/80 py-1 pl-1 pr-2.5 text-[10px] font-semibold text-[#1197c5] shadow-sm backdrop-blur-md dark:border-[#1197c5]/40 dark:bg-white/10 md:hidden"><GoogleIcon className="size-4" /> Registrarse o iniciar sesión</motion.button>
